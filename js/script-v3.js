...
function handleRadioButtonChange(radioButton) {
  ...
  totalDiscount.textContent = 'PRIHRANITE ' + formatPrice((oldPrice - actualPrice));

  // update link for selected package
  if(Number(selectedPackage) === 3) {
    addToCartLink.href = 'https://swisspower.si/cart/45120453705993:3';
    totalOldPrice.classList.remove('hide')
    totalDiscount.classList.remove('hide')
  } else if (Number(selectedPackage) === 1) {
    addToCartLink.href = 'https://swisspower.si/cart/45120453705993:1';
    totalOldPrice.classList.remove('hide')
    totalDiscount.classList.remove('hide')
  } else {
    addToCartLink.href = 'https://swisspower.si/cart/45120453705993:' + selectedPackage;
    totalOldPrice.classList.remove('hide')
    totalDiscount.classList.remove('hide')
  }
